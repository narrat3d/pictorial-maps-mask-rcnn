...
# where training and validation data are stored
DATA_FOLDER = r"E:\CNN\masks\tensorflow\characters"

# model which will be retrained
COCO_WEIGHTS_PATH = r"E:\CNN\models\mask_rcnn_resnet101_atrous_coco_2018_01_28\model.ckpt"

CONFIG_FILE_PATH = os.path.join(DATA_FOLDER, "mask_rcnn_resnet101_atrous.config")
CONFIG_FILE_TEMPLATE_PATH = os.path.join(DATA_FOLDER, "mask_rcnn_resnet101_atrous_template.config")

LABEL_MAP_PATH = os.path.join(DATA_FOLDER, "label_map.pbtxt")
TRAIN_RECORD_PATH = os.path.join(DATA_FOLDER, "train_%s.record")
EVAL_RECORD_PATH = os.path.join(DATA_FOLDER, "eval_%s.record")
...
get_eval_record_path = lambda data_set_name: EVAL_RECORD_PATH % data_set_name
